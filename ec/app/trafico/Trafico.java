...
public class Trafico extends Problem implements SimpleProblemForm {
    ...
    public void evaluate(final EvolutionState state, final Individual ind, final int subpopulation, final int threadnum) {
        ...
        ind.evaluated = true;
        System.out.print("Finish evaluate");
    }
    ...
    public double qos (Individual ind){
        ...
        for (int i = 0; i < t_ind.genome.length; i++){
            ...
            System.out.println(segment.start.x);
              System.out.println(segment.start.y);
              System.out.println(segment.end.x);
              System.out.println(segment.end.y);
            double coverered_distance = 0;
            for (LineSegment combination : combinations) {
              System.out.println("####");
              System.out.println(combination.start.x);
              System.out.println(combination.start.y);
              System.out.println(combination.end.x);
              System.out.println(combination.end.y);
